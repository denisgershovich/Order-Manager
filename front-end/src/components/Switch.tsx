      ...
      <input
        className="mr-2 mt-[0.3rem] h-3.5 w-8 appearance-none rounded-[0.4375rem]
         ...
         after:h-5 after:w-5 after:rounded-full after:border-none
          after:bg-neutral-500 after:shadow-[0_0px_3px_0_rgb(0_0_0_/_7%),_0_2px_2px_0_rgb(0,0,0_/_4%)] 
          after:transition-[background-color_0.2s,transform_0.2s] after:content-['']
          checked:bg-blue-400 checked:after:absolute checked:after:z-[2] checked:after:-mt-[3px] 
          checked:after:ml-[1.0625rem] checked:after:h-5 checked:after:w-5 checked:after:rounded-full checked:after:border-none
          checked:after:bg-blue-400 checked:after:shadow-[0_3px_1px_-2px_rgba(0,0,0,0.2),_0,2px_2px_0_rgba(0,0,0,0.14),_0_1px_5px_0_rgba(0,0,0,0.12)]
